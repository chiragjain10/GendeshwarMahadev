...
import { FaArrowRight, FaPlay, FaPause, FaHeart, FaHandHoldingHeart } from "react-icons/fa";

const banners = [
  {
    id: 1,
    title: "Welcome to Shiva Dham Temple",
    subtitle: "Experience Divine Peace",
    text: "Our sacred temple is dedicated to Lord Shiva, offering a divine space for worship, meditation, and spiritual enlightenment. Join us in daily rituals and experience Shiva's blessings.",
    image: "https://images.unsplash.com/photo-1589994965851-a8f479c573a9?w=500&h=400&fit=crop",
    bg: "https://images.unsplash.com/photo-1603383928972-0fe54f8a2b4f?w=1200&h=800&fit=crop",
    align: "left"
  },
  {
    id: 2,
    title: "Daily Rudrabhishek & Aarti",
    subtitle: "Divine Shiva Blessings",
    text: "Participate in our sacred Rudrabhishek ceremonies and experience Lord Shiva's divine grace. Our experienced priests conduct authentic Vedic rituals for peace and prosperity.",
    image: "https://images.unsplash.com/photo-1548351514-8b6d0f6c7499?w=500&h=400&fit=crop",
    bg: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&h=800&fit=crop",
    align: "right"
  },
];
            ...
            <div className="max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap gap-8 justify-center lg:justify-start">
                <div className="text-center">
                  ...
                  <div className="text-red-200 text-sm">Daily Pujas</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">1000+</div>
                  <div className="text-red-200 text-sm">Happy Devotees</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">24/7</div>
                  <div className="text-red-200 text-sm">Temple Open</div>
                </div>
              </div>
            </div>
          </div>
